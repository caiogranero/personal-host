...
module.exports = (app) => {
  app.post(`${baseUrl}`, routerHandler(remedioController.NovoRemedio, (req, res, next) => [
  ...
  app.delete(`${baseUrl}/:remedioId`, routerHandler(remedioController.RemoverRemedio, (req, res, next) => [
    req.params.usuarioId,
    req.params.remedioId,
  ]));
};
