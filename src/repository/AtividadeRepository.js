  ...
  ListAll() {
    const atividades = [
      ...
      },
      {
        ...
        contexto: "Esportes",
        atividade:
          "Atletismo (salto em altura, distância e triplo, dardo, salto com vara)"
      },
      {
        codigo: 15734,
        met: 10.0,
      ...
      },
      {
        ...
        contexto: "Esportes",
        atividade:
          "Malabarismo (com as mãos, lançando objetos para cima e recuperando-os)"
      },
      {
        codigo: 15450,
        met: 7.0,
      ...
      },
      {
        ...
        contexto: "Esportes",
        atividade:
          "Jogos de criança com movimentação corporal intensa (amarelinha, 4-quadros, queimado, brinquedos de playgroud, taco etc)"
      },
      {
        codigo: 15140,
        met: 4.0,
        contexto: "Esportes",
        atividade:
          "Treinar: futebol americano, futebol, basquetebol, basebol, natação, etc"
      },
      {
        codigo: 15150,
        met: 5.0,
      ...
      },
      {
        ...
        contexto: "Esportes",
        atividade:
          "Curling (desporto de equipe praticado sobre o gelo, no qual se busca impulsionar rochas de 19 kg na direção de um alvo de 3,6 m de diâmetro)"
      },
      {
        codigo: 02080,
        met: 7.0,
      ...
      },
      {
        ...
        contexto: "Exercício de Condicionamento",
        atividade:
          "Slimnastics, jazzercise (atividades ginásticas envolvendo movimento do jazz enquanto dança)"
      },
      {
        codigo: 02100,
        met: 2.5,
      ...
      },
      {
        ...
        contexto: "Exercício de Condicionamento",
        atividade:
          "Levantamento de pesos, esforço leve ou moderado, rotina leve"
      },
      {
        codigo: 02135,
        met: 1.0,
      ...
      },
      {
        ...
        contexto: "Exercício de Condicionamento",
        atividade:
          "Calistenia (i.e., flexões, abdominais, puxadas), pesado, esforço vigoroso"
      },
      {
        codigo: 02040,
        met: 8.0,
      ...
      },
      {
        ...
        contexto: "Exercício de Condicionamento",
        atividade:
          "Levantamento de peso, power-lifting ou fisiculturismo, esforço vigoroso"
      },
      {
        codigo: 02060,
        met: 5.5,
      ...
      },
      {
        ...
        contexto: "Ciclismo",
        atividade:
          "Ciclismo, 22 a 25 km/h, corrida ou lazer, rápido, esforço vigoroso"
      },
      {
        codigo: 01050,
        met: 12.0,
        contexto: "Ciclismo",
        atividade:
          "Ciclismo, 25 a 30 km/h, corrida/sem explosão ou > 30 km/h, explosivo, muito veloz, corrida em geral"
      },
      {
        codigo: 01060,
        met: 16.0,
      ...
      },
      {
        ...
        contexto: "Dança",
        atividade:
          "Balé ou dança moderna, twist, jazz, sapateado, jitterbug (dança em seis tempos, em pares, caracterizada por rodopios velozes – rockabilly)"
      },
      {
        codigo: 03015,
        met: 6.5,
      ...
      },
      {
        ...
        contexto: "Dança",
        atividade:
          "Geral, Grega, Oriente Médio, hula, flamenco, swing, dança do ventre"
      },
      {
        codigo: 03030,
        met: 5.5,
      ...
      },
      {
        ...
        contexto: "Dança",
        atividade:
          "Dança de salão, rápido (disco, folk, square), line dancing (similar à quadrilha brasileira), dança irlandesa, polka, country"
      },
      {
        codigo: 03040,
        met: 3.0,
        contexto: "Dança",
        atividade:
          "Dança de salão, devagar (p.ex., valsa, foxtrot, dança lenta), samba, tango, séc XIX, mambo, chacha"
      },
      {
        codigo: 03050,
        met: 5.5,
        contexto: "Dança",
        atividade:
          "Anishinaabe ou outra dança ameríndia tradicional (danças indígenas em geral)"
      },
      {
        codigo: 12010,
        met: 6.0,
        contexto: "Correr",
        atividade:
          "Combinação de caminhada e atividades laborais (componente laboral com menos de 10 minutos)"
      },
      {
        codigo: 12020,
        met: 7.0,
      ...
      },
      {
        ...
        contexto: "Correr",
        atividade:
          "Correr, treinamento, empurrar cadeira de roda em situação competitiva"
      },
      {
        codigo: 17070,
        met: 3.0,
      ...
      },
      {
        ...
        contexto: "Caminhar",
        atividade:
          "Caminhar, menos 3 km/h, de modo confortável, em terreno plano, bem devagar"
      },
      {
        codigo: 17152,
        met: 2.5,
      ...
      },
      {
        ...
        contexto: "Caminhar",
        atividade:
          "Caminhar da casa para o carro ou ônibus, do carro ou ônibus para outros lugares, como o trabalho"
      },
      {
        codigo: 17162,
        met: 2.5,
        contexto: "Caminhar",
        atividade:
          "Caminhar até a casa de vizinhos ou familiares por razões sociais"
      },
      {
        codigo: 17165,
        met: 3.0,
      ...
      },
      {
        ...
        contexto: "Caminhar",
        atividade:
          "Caminhar, 5 km/h, terreno plano, superfície firme, ritmo moderado"
      },
      {
        codigo: 17200,
        met: 3.8,
        contexto: "Caminhar",
        atividade:
          "Caminhar, 5,5 km/h, terreno plano, superfície firme, caminhando para exercitar-se, ritmo rápido"
      },
      {
        codigo: 17210,
        met: 6.0,
      ...
      },
      {
        ...
        contexto: "Caminhar",
        atividade:
          "Caminhar, 6,5 km/h, terreno plano, superfície firme, ritmo muito rápido"
      },
      {
        codigo: 17230,
        met: 6.3,
        contexto: "Caminhar",
        atividade:
          "Caminhar, 7 km/h, terreno plano, superfície firme, ritmo extremamente rápido"
      },
      {
        codigo: 17231,
        met: 8.0,
